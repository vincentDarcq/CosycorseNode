...
exports.sendMailForBooking = async (req, res, next) => {
  ...
  const html = `<b>Vous avez une demande de réservation :</b>
                ...
                <a style="border: solid 1px green; padding: 5px; margin: 5px; background-color: green; color: white; text-decoration :none;" href="${env.apiUrl}/api/logementReservation/accepteReservation?logementReservationId=${res.locals.lr._id}">Accepter</a>
                <a style="border: solid 1px red; padding: 5px; margin: 5px; background-color: red; color: white; text-decoration :none;" href="${env.apiUrl}/api/logementReservation/rejectReservation">Refuser</a>
                </div>`
